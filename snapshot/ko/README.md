...
| **시간 구간별 집계** | 목록과 같은 검색 조건으로 기간별 건수를 데이터베이스에서 집계 |
...
상세한 연산자 목록과 사용법은 [검색 연산자](ko/search-operators.md) 문서를 참조하세요.
...
| [API 레퍼런스](ko/api-reference.md) | 전체 API 문서 |
| [자주 묻는 질문](ko/faq.md) | FAQ 및 문제 해결 |
