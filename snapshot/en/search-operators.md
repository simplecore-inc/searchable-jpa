...
> **Note**: For basic DTO configuration and `SearchableField` annotation usage, see [Basic Usage](en/basic-usage.md).
...
- [Two-Phase Query Optimization](en/two-phase-query-optimization.md) - a high-performance pagination system
- [Advanced Features](en/advanced-features.md) - complex search conditions and nested queries
