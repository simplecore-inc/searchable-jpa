...
For the full list of operators and usage details, see [Search Operators](en/search-operators.md).
...
| Guide | Description |
|--------|------|
| [Installation Guide](en/installation.md) | System requirements and installation instructions |
| [Basic Usage](en/basic-usage.md) | Basic usage and examples |
| [Auto Configuration](en/auto-configuration.md) | Spring Boot auto-configuration and Hibernate optimization options |
| [Search Operators](en/search-operators.md) | All supported search operators |
| [Two-Phase Query Optimization](en/two-phase-query-optimization.md) | High-performance pagination for large datasets |
| [Relationships and Two-Phase Query](en/relationship-and-two-phase-query.md) | JPA relationship mapping and resolving the N+1 problem |
| [Advanced Features](en/advanced-features.md) | Complex search conditions and advanced features |
| [OpenAPI Integration](en/openapi-integration.md) | Automatic Swagger documentation generation |
| [API Reference](en/api-reference.md) | Complete API documentation |
| [FAQ](en/faq.md) | FAQ and troubleshooting |
...
This project is distributed under the [SimpleCORE License 1.0 (SCL-1.0)](en/license.md).
